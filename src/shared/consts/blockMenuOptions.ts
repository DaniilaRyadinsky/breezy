...
export const BLOCK_OPTIONS: BlockOption[] = [
  ...
  { type: "header_2", label: "Заголовок 2", icon: Heading2 },
  { type: "header_3", label: "Заголовок 3", icon: Heading3 },
  { type: "header_4", label: "Заголовок 4", icon: Heading4 },
  { type: "unordered", label: "Маркированный список", icon: ListIcon },
  { type: "ordered", label: "Нумерованный список", icon: ListOrdered },
  { type: "todo", label: "Todo список", icon: ListTodo },
