...
import { NotesTitle, NotesTitleH1, NotesTitleH2, NotesTitleH3 } from '../../entities/note/note-title/notes-title'
import NotesText from '../../entities/note/note-text/notes-text'
import styles from './NoteEditor.module.css'

export const NoteEditor = ({blocks, setBlocks, filename, setFilename}) => {
